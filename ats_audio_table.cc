...
static void pause_audio(b32 pause) {
...
static void kill_all_audio(void) {
...
static void play_audio(Audio_ID id, f32 volume = 1.0) {
...
static cs_playing_sound_t* play_looped_audio(Audio_ID id, f32 volume = 1.0) {
    if (Audio_Entry* entry = audio_get_entry(id)) {
        cs_playing_sound_t* playing = cs_play_sound(audio.context, entry->playing);
...
static void play_music(Audio_ID id, f32 volume = 1.0) {
...
static void play_audio_from_source(Audio_ID id, v3 pos, v3 dir, v3 source, f32 volume = 1.0, f32 max_distance = 16.0) {
    ...
    if (Audio_Entry* entry = audio_get_entry(id)) {
        ...
        csp_set_pitch(playing, 1.0f + rand_f32(-0.05f, 0.1f), audio.pitch_id);
