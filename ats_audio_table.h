...
extern void     audio_play_from_source(Audio_ID id, Vec3 pos, Vec3 dir, Vec3 source, f32 volume, f32 max_distance);
...
extern void
audio_play_from_source(Audio_ID id, Vec3 pos, Vec3 dir, Vec3 source, f32 volume, f32 max_distance) {
    ...
    if (entry) {
        ...
        f32 pan = get_angle(dir.xy, source_dir) / PI;
