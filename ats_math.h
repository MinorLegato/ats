...
static v2 operator-(v2 u)
{
   return { -u.x, -u.y };
}

static v3 operator-(v3 u)
{
   return { -u.x, -u.y, -u.z };
}

static v4 operator-(v4 u)
{
   return { -u.x, -u.y, -u.z, -u.w };
}

static v2i operator-(v2i u)
{
   return { -u.x, -u.y };
}

static v3i operator-(v3i u)
{
   return { -u.x, -u.y, -u.z };
}

static v4i operator-(v4i u)
{
   return { -u.x, -u.y, -u.z, -u.w };
}
...
static m2 operator*(m2 a, m2 b)
{
   return m2_mul(a, b);
}

static m3 operator*(m3 a, m3 b)
{
   return m3_mul(a, b);
}
...
static v2i& operator*=(v2i& a, f32 s)
{
   a = a * s;
   return a;
}

static v3i& operator*=(v3i& a, f32 s)
{
   a = a * s;
   return a;
}

static v4i& operator*=(v4i& a, f32 s)
{
   a = a * s;
   return a;
}
...
static b32 operator==(v2i a, v2i b)
{ 
   return a.x == b.x && a.y == b.y;
}

static b32 operator==(v3i a, v3i b)
{
   return a.x == b.x && a.y == b.y && a.z == b.z;
}

static b32 operator==(v4i a, v4i b)
{
   return a.x == b.x && a.y == b.y && a.z == b.z && a.w == b.w;
}
